public class Producto { // Declara una clase llamada Producto
    ...
    public void generarEtiqueta() { // Método para generar una etiqueta del producto
        System.out.println("Producto: " + nombre + ", Precio: " + calcularPrecioFinal());
    }

    public void guardar() { // Método para guardar la información del producto (simulación de persistencia)
